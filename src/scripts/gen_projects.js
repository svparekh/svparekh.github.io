...
export class PTag extends PElement {
...
export class PLanguage extends PElement {
...
export class Project extends PElement {
    constructor(_name, { img, url, tags, languages, description }) {
        super(_name);
        this.img = img;
        this.url = url;
        this.tags = tags;
    ...
    toHTML() {
        ...
        <div class="swiper-slide project-card-slide">\
            <div class="project-card-container" href="' + this.url + '">\
                <!-- Title, Tags, Thumbnail -->\
                <div class="project-card-top">\
                    <!-- Title -->\
                    <h2 class="project-title no-animate-on-view">' + this.name + '</h2>\
                    <!-- Thumbnail -->\
                    <img src="' + this.img + '" alt="' + this.name + ' Thumbnail" class="project-thumbnail">\
                </div>\
                <!-- Tags -->\
