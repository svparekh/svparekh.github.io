...
export function generateTimeline(sections) {
    ...
    for (const section of sections) {
        ...
        if (base < deadZoneLeft || base > deadZoneRight) {
            svgArrowImage.src = new URL('../assets/svg_scribbles/curved_arrow.svg?as=webp', import.meta.url);
            ...
            svgArrowImage.src = new URL('../assets/svg_scribbles/straight_arrow.svg?as=webp', import.meta.url);
        }
        if (base < timelineWidth / 2) {
        ...
        sectionElement.addEventListener("click", () => {
            ...
            sectionElement.classList.add("active-section");
            // set arrow
            const currentActiveArrow = document.querySelector(".active-arrow");
...
export function generateTimelinePoints(timelinePoints) {
    const timeRange = timelinePoints[timelinePoints.length - 1].date - timelinePoints[0].date;
