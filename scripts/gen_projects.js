        ...
        <div class="swiper-slide project-card-slide">\
            <div class="project-card-container" href="' + this.url + '" target="_blank">\
                ...
                <div class="project-card-top">\
                    <!-- Title -->\
                    <h2 class="project-title">' + this.name + '</h2>\
                    <!-- Thumbnail -->\
...
const all_projects = [
    new Project("Internal Package Registry", "project-1.png", "https://github.com/svparekh/Package-Registry-ECE461-Project-ACMEIR",
        ...
        "Some description is to be written here but currently there is no such allowance in the design process and so I wrote this increasingly long sentence for no real reason other than to mitigate the temporal difference"),
